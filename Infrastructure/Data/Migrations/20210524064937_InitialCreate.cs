        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 10, "Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus.", "Bliue Code Gloves", "images/products/glove-code1.png", 18m, 3, 4 },
                    ...
                    { 9, "Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.", "Blue React Woolen Hat", "images/products/hat-react2.png", 15m, 4, 2 },
                    { 8, "Suspendisse dui purus, scelerisque at, vulputate vitae, pretium mattis, nunc. Mauris eget neque at sem venenatis eleifend. Ut nonummy.", "Greaan React Woolen Hat", "images/products/hat-react1.png", 8m, 4, 2 },
                    { 7, "Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.", "Core Maroon Hat", "images/products/hat-core1.png", 10m, 2, 2 },
                    { 6, "Aenean nec lorem. In porttitor. Donec laoreet nonummy augue.", "Typescript Entry Board", "images/products/sb-ts1.png", 120m, 5, 1 },
                    { 5, "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.", "React Board Supper Whizzy Fast", "images/products/sb-react1.png", 250m, 4, 1 },
